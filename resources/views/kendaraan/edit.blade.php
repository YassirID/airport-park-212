        ...
        <div class="bg-cyan-500/10 border border-cyan-500/20 rounded-xl p-4 mb-6 mt-2">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-cyan-400/80 leading-relaxed">Format: <span class="font-mono font-bold text-white">XX 1234 XXX</span> — Huruf depan (kode wilayah), angka (nomor registrasi), huruf belakang (seri).</p>
                </div>
            </div>
        </div>
